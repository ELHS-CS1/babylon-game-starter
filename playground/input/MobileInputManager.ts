...
export class MobileInputManager {
     ...
     */
    public static initialize(_canvas: HTMLCanvasElement): void {
        ...
        this.setupMobileCanvas(_canvas);

        this.createJoystick(_canvas);
        this.createActionButtons(_canvas);
        this.setupTouchEventListeners(_canvas);
     ...
     * @param canvas The canvas element
     */
    private static setupTouchEventListeners(_canvas: HTMLCanvasElement): void {
     ...
     * @param e Touch, Pointer, or Mouse event
     */
    private static handleGlobalTouchEnd(_e: TouchEvent | PointerEvent | MouseEvent): void {
